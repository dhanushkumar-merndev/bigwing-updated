...
const statConfig = [
  ...
  { key: "rnr" as const, label: "RNR", textColor: "text-chart-1", bgColor: "bg-chart-1/10", pillBg: "bg-chart-1/15", pillText: "text-chart-1", barColor: "bg-chart-1", icon: "M12 9v4m0 4h.01M10.29 3.86l-7.5 13A1 1 0 003.66 18h16.68a1 1 0 00.87-1.5l-7.5-13a1 1 0 00-1.74 0z" },
